                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" value="{{ old('price') }}" required step="0.01" min="0" placeholder="0" class="w-full pl-10 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-amber-400 transition cursor-pointer" id="image-dropzone">
                            ...
                            <img id="image-preview" class="hidden w-full rounded-lg object-cover max-h-48">
